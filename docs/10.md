...
<span id="jump511">**引理 5.1**</span> 对于任意函数 $f:S\mapsto\mathbb{E}$ 和任意策略 $\pi$，我们有：
...
这一引理的证明可以参见 [4] 以及[附录 A.1](#jump512)。
...
### <span id="jump512">A.1 奖励调整（Reward Shaping）</span>

这里我们证明[引理 5.1](#jump511)。