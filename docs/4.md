...
$$
= \frac{\epsilon}{|A|} \sum_{a\in A}Q^{\pi_i}(s,a) + (1-\epsilon)\mathop{\max}_{a^{'}}Q^{\pi_i}(s,a^{'}) \sum_{a\in A} \frac{\pi_{i}(a|s)- a}{1-\epsilon}
$$

$$
= \frac{\epsilon}{|A|} \sum_{a\in A}Q^{\pi_i}(s,a) + (1-\epsilon)
$$